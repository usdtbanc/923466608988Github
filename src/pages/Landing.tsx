...
export const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="rounded-2xl border border-border bg-card p-6 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all group"
              >
                <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${item.accent} p-0.5 mb-4`}>
      ...
      <section id="how-it-works" className="py-16 sm:py-24 bg-card/50 border-y border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-8 relative">
            ...
            <div className="absolute top-8 left-1/6 right-1/6 h-0.5 bg-gradient-to-r from-primary to-secondary hidden sm:block opacity-30" />

            {[
              {
                step: '01',
                title: 'Create Account',
                desc: 'Sign up with your email and set a strong password. Email verification keeps your account secure.',
                icon: CheckCircle,
              },
              {
                step: '02',
                title: 'Set Up Wallet',
                desc: 'Your embedded wallet is created automatically. A mnemonic is generated and encrypted locally on your device.',
                icon: Wallet,
              },
              {
                step: '03',
                title: 'Buy & Manage',
                desc: 'Choose your region (Americas or Eurozone), buy crypto with fiat, and manage all chains from one place.',
                icon: Zap,
              },
            ].map((s, i) => (
              <motion.div
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary to-secondary mx-auto mb-4 flex items-center justify-center shadow-lg shadow-primary/20 relative z-10">
      ...
      {/* ── Security & Trust ─────────────────────────────────────────────────── */}
      <section id="security" className="py-16 sm:py-24 bg-card/50 border-y border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-black text-foreground mb-3">Security you can verify</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">We rely on battle-tested cryptography standards — not trust.</p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Mnemonics are encrypted with 256-bit AES-GCM using PBKDF2 key derivation (150,000 iterations). Your vault never leaves your browser.',
              },
              {
                icon: Shield,
                title: 'TOTP 2-Factor Auth',
                desc: 'Every withdrawal is gated by a time-based one-time password (RFC 6238) generated in your authenticator app.',
              },
              {
                icon: Zap,
                title: 'Zero Server Storage',
                desc: 'Private keys, mnemonics, and withdrawal passwords are never transmitted to or stored on our servers.',
              },
              {
                icon: CheckCircle,
                title: 'Dedicated Withdrawal PIN',
                desc: 'Separate from your login password, the withdrawal PIN is an additional layer ensuring only you can move funds.',
              },
            ].map((item) => (
              <motion.div
                key={item.title}
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.4 }}
                className="rounded-2xl border border-border bg-background p-5 text-center hover:border-primary/40 transition-colors"
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 border border-primary/20 mx-auto mb-4 flex items-center justify-center">
                  <item.icon className="h-5 w-5 text-primary" />
                </div>
