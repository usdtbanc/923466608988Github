    ...
    <div className="w-full h-full flex flex-col relative bg-background">
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-0">
          <div className="p-1.5 sm:p-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-500">
            <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
          </div>
          <div className="text-center sm:text-left">
            <h2 className="text-base sm:text-lg lg:text-xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 bg-clip-text text-transparent">
              💶 Eurozone Platform
            </h2>
            <p className="text-xs sm:text-sm text-muted-foreground">
              Buy ETH on Sepolia • EUR
              {address && (
