import {
  CheckCircle2, BookOpen, ShieldCheck, UserCog, Layers, Wallet,
  Globe, KeyRound, Coins, Receipt, Ban, Mail, type LucideIcon,
} from "lucide-react";

/**
 * Single source of truth for the Terms of Service content, shared by the
 * full /terms page (Terms.tsx) and the signup scroll-to-accept box (Auth.tsx),
...
export const TERMS_SECTIONS: TermsSection[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "By using an Embedded Wallet, you also enter into a direct relationship with Privy as the provider of that wallet infrastructure, governed by Privy's own End User Terms of Service, available at https://www.privy.io/user-terms-of-service. That agreement is between you and Privy, is maintained solely by Privy, and confirms that Privy provides only self-custodial wallets, does not have access to your private keys or recovery phrase, and cannot make transactions on your behalf. You are responsible for reviewing and accepting Privy's End User Terms of Service directly.",
      "Under Privy's End User Terms of Service, Privy does not and will not act as a custodian of your wallet or credentials under any circumstances, does not guarantee that any wallet or its contents can be recovered, and disclaims liability for losses arising from user error (such as forgotten credentials, incorrectly constructed transactions, or mistyped addresses), server failure or data loss, corrupted wallet files, or unauthorized third-party access. You are solely responsible for safeguarding your Embedded Wallet's private keys, recovery phrase, passwords, and any other credentials, and for all activity conducted through it.",
      "You may terminate your direct relationship with Privy at any time by contacting Privy directly, and you will retain the ability to export your Embedded Wallet's private keys or other wallet data at that time, independent of your Account status with the Company. Privy may independently suspend or terminate your access to its wallet infrastructure in accordance with its own terms, separately from any action the Company takes with respect to your Account.",
      "The Company is a \"Developer\" under Privy's terms and has integrated Privy's wallet infrastructure into the Platform for the benefit of Platform users. Privy is not responsible for the Company's own products, services, or conduct, and the Company is not responsible for Privy's infrastructure, uptime, or independent decisions regarding your Embedded Wallet. Each of the Company and Privy is responsible only for its own respective services, and any dispute you have directly with Privy regarding your Embedded Wallet is governed exclusively by Privy's own End User Terms of Service, including its own dispute resolution provisions, and not by Section 24 of these Terms.",
  ...
  },
  {
    ...
    points: [
      "Fiat on-ramp transactions available through the Platform are processed by Stripe, an independent Third-Party Provider. Embedded Wallet infrastructure is provided by Privy. Backend data infrastructure is provided by Supabase. Hosting and domain services are provided by Namecheap. The Company may engage additional Third-Party Providers, or replace or remove any existing Third-Party Provider, at any time. Your use of a Third-Party Provider's services, including Stripe's buy functionality, is subject to that Third-Party Provider's own terms of service, privacy policy, and compliance procedures, which you are responsible for reviewing and accepting separately. The Company is not a party to your relationship with any Third-Party Provider and is not responsible or liable for any Third-Party Provider's acts, omissions, errors, delays, fees, exchange rates, service interruptions, or compliance decisions, including decisions to decline, delay, freeze, or reverse a transaction.",
      "By using the Platform's Fiat On-Ramp functionality, you enter into a direct relationship with Stripe as the provider of that functionality, governed by Stripe's own Fiat-to-Crypto Onramp Terms, available at https://stripe.com/legal/crypto-onramp. That agreement is between you and Stripe, is maintained solely by Stripe, and governs your identity verification, payment, and cryptocurrency purchase transaction, including with any Exchange Provider Stripe engages to fulfill the transaction. You are responsible for reviewing and accepting Stripe's Fiat-to-Crypto Onramp Terms directly before completing a purchase.",
  ...
  },
  {
    ...
    points: [
      ...
      "Third-Party Providers, including Stripe, may separately charge their own processing fees, apply their own foreign exchange rates or spreads, and pass through Blockchain network fees, gas fees, or other third-party charges. These amounts are set and collected by the applicable Third-Party Provider, not by the Company, and are disclosed to you by that provider before you confirm a transaction.",
